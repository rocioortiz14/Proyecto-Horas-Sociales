<!-- Modal -->
<div class="modal fade" id="agregarClModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
      ...
      <div class="modal-body">
        <form class="" action="" method="post" id="formACliente">
          <div class="form-group">
            <label for="" class="form-label text-dark">Nombres: </label>
            <input type="text" class="form-control" name="inputNombre" id="inputNombre">
          </div>
          <div class="form-group">
            <label for="" class="form-label text-dark">Apellidos: </label>
