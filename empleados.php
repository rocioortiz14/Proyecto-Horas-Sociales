...
<html lang="es">
  ...
  <body>
        ...
        <div class="page-body">
          ...
          <div class="container-fluid">
            <div class="page-title">
              <div class="row">
                <div class="col-6">
                  <h3> Administracion de empleados del sistema</h3>
                </div>
                <div class="col-6">
                  <ol class="breadcrumb">
          ...
          <div class="container-fluid">
            <div class="row">
              <div class="col-md-12">
                <a href="#" class="btn btn-primary btn-md" id="btnAdd" data-bs-toggle="modal" data-bs-target="#agregarEmplModal"> <i class="fa fa-plus"></i> Agregar Empleados</a>
                <hr>
                <div class="table-responsive-md" id="mostrarTablaEmpleados"></div>
              </div>
            </div>
          </div>
    ...
    <?php
      include 'modales/agregarEmpleados.php';
      include 'modales/editarEmpleados.php';
    ?>
    <?php include 'secciones/scripts.php'; // Incluimos los archivos js a la plantilla. ?>
    <script src="assets/js/scrollbar/simplebar.js"></script>
    <script src="assets/js/scrollbar/custom.js"></script>
    <script src="ajax/ajaxEmpleados.js" charset="utf-8"></script>
  </body>
</html>
