            ...
            <ul class="horizontal-menu">
              ...
              <li class="level-menu outside"><a class="nav-link" href="#!"><i data-feather="inbox"></i><span> Configuraciones</span></a>
                <ul class="header-level-menu menu-to-be-close">
                  <li><a href="usuarios.php" data-original-title="" title=""><i data-feather="airplay"></i><span>Usuarios</span></a></li>
                  <li><a href="#" data-original-title="" title=""><i data-feather="heart"></i><span>Permisos</span></a></li>
                  <hr>
                  <li><a href="#" data-original-title="" title=""><i data-feather="heart"></i><span>Empresa</span></a></li>
                  <li><a href="#" data-original-title="" title=""><i data-feather="zap"></i><span>Empleados</span></a></li>
                </ul>
              </li>
            </ul>
          </div>
            ...
            <ul class="nav-menus">
              ...
              <li class="profile-nav onhover-dropdown p-0 me-0">
                ...
                <ul class="profile-dropdown onhover-show-div">
                  ...
                  <li><a href="cierre.php"><i data-feather="log-in"> </i><span> Cerrar sesiòn</span></a></li>
                </ul>
              </li>
            </ul>
          </div>
