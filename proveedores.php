...
<html lang="es">
  ...
  <body>
        ...
        <div class="page-body">
          <div class="container-fluid">
            <div class="page-title">
              <div class="row">
                <div class="col-6">
                  <h3> Administracion de Proveedores del Sistema</h3>
                </div>
                <div class="col-6">
                  <ol class="breadcrumb">
          ...
          <div class="container-fluid">
            <div class="row">
              <div class="col-md-12">
                <a href="#" class="btn btn-primary btn-md" id="btnAdd" data-bs-toggle="modal" data-bs-target="#agregarPrvModal"> <i class="fa fa-plus"></i> Agregar Proveedores</a>
                <hr>
                <div class="table-responsive-md" id="mostrarTablaProveedores"></div>
              </div>
            </div>
          </div>
    ...
    <?php
      include 'modales/agregarProveedores.php';
