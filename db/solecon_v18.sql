...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 07-12-2021 a las 22:27:08
...
(1, 6, '::1', '2021-12-07 14:52:38', '2021-12-07 14:52:38');
...
(1, 'CAFE EL MOROS', 'CAFE EN GRANO TOSTADO', 1, '13.00', '2.50', '3.50', '45789', NULL, NULL, 1, 'IMG-61afcf00c4a9d9.82860407.png');
...
--
ALTER TABLE `tbl_proveedores`
  MODIFY `prv_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
