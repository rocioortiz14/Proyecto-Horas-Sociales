...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 03-11-2021 a las 06:31:22
...
(1, 'EMPRESA DEMO, NO SE SU NOMBRE 33 Y CON TÍLDE 222', 'HAS LA PAZ Y NO LA GUERRA X2', '2661-3333', '2663-3333', '7455-3333', '7566-3333', 'NO TENGO DIRECCIÓN PORQUE ES UNA EMPRESA FICTICIA 73', 'noname@outlook.com', 'PUES NO SABEMOS CUAL ES AHORA', '1-99-8899133', '101-187596-125-433', 'IMG-616f732e03c777.03674978.jpeg');
...
CREATE TABLE `tbl_productos` (
  `p_id` int(11) NOT NULL,
  `p_producto` text COLLATE utf8_spanish_ci NOT NULL,
  `p_desc` text COLLATE utf8_spanish_ci NOT NULL,
  `p_categoria` int(11) NOT NULL,
  `p_stock` int(11) NOT NULL,
  `p_codigo` varchar(100) COLLATE utf8_spanish_ci NOT NULL,
  `p_perecedero` tinyint(4) NOT NULL,
  `p_perecedero_p` date NOT NULL,
